...
```json
{
  "annotations": {
    "list": [
      ...
      {
        "datasource": "Prometheus-dsp-executor",
        "enable": true,
  ...
  "panels": [
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "sum(service_gateway_http_request_total)by (instance)",
          "format": "time_series",
          "intervalFactor": 1,
          "refId": "A"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "sum(service_gateway_http_request_total)by(method)",
          "format": "time_series",
          "intervalFactor": 1,
          "refId": "A"
        },
        {
          "expr": "sum(service_gateway_http_request_total)",
          "format": "time_series",
          "intervalFactor": 1,
          "refId": "B"
        }
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "irate(service_gateway_loadbalancer_total{application=\"$application\",kubernetes_namespace=\"$namespace\"}[1m])",
          "format": "time_series",
          "intervalFactor": 1,
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "service_gateway_loadbalancer_total{application=\"$application\",kubernetes_namespace=\"$namespace\"}",
          "format": "time_series",
          "intervalFactor": 1,
          "legendFormat": "{{instance}}",
          "refId": "A"
    ...
    },
    {
      ...
      "targets": [
        {
          "expr": "logback_events_total{application=\"$application\", instance=\"$instance\"}",
          "format": "time_series",
          "interval": "",
          "intervalFactor": 2,
          "legendFormat": "{{level}}",
    ...
    "list": [
      {
        ...
        "datasource": "Prometheus-dsp-executor",
        "definition": "label_values(jvm_memory_used_bytes{kubernetes_namespace=~\"dsp.*\"}, kubernetes_namespace)",
        "hide": 0,
        "includeAll": false,
        "label": "namespace",
        "multi": false,
        ...
        "options": [
          ...
          {
            "selected": false,
            "text": "dsp-c4tuzbwm-tenant-test",
            "value": "dsp-c4tuzbwm-tenant-test"
          },
          {
            "selected": false,
            "text": "dsp-se86dj0a",
        ...
        "query": "label_values(jvm_memory_used_bytes{kubernetes_namespace=~\"dsp.*\"}, kubernetes_namespace)",
        "refresh": 0,
        "regex": "",
        "skipUrlSync": false,
        "sort": 0,
      ...
      },
      {
        ...
        "current": {
          "selected": true,
          "text": "dsp-service-gateway",
          "value": "dsp-service-gateway"
        },
        "datasource": "Prometheus-dsp-executor",
        "definition": "",
        "hide": 0,
      ...
      },
      {
        ...
        "allValue": null,
        "current": {
          "text": "172.17.30.25:28088",
          "value": "172.17.30.25:28088"
        },
        "datasource": "Prometheus-dsp-executor",
        "definition": "label_values(jvm_memory_used_bytes{application=\"$application\",kubernetes_namespace=\"$namespace\"}, instance)",
        "hide": 0,
        "includeAll": false,
        "label": "Instance",
        "multi": false,
        ...
        "name": "instance",
        "options": [],
        "query": "label_values(jvm_memory_used_bytes{application=\"$application\",kubernetes_namespace=\"$namespace\"}, instance)",
        "refresh": 1,
        "regex": "",
        "skipUrlSync": false,
        "sort": 0,
      ...
      },
      {
        "allValue": null,
        "current": {
          "text": "dps-service-gateway-74dbdd75cb-v9n8g",
          "value": "dps-service-gateway-74dbdd75cb-v9n8g"
        },
        "datasource": "Prometheus-dsp-executor",
        "definition": "label_values(jvm_memory_used_bytes{application =\"$application\", kubernetes_namespace =\"$namespace\"}, kubernetes_pod_name)",
        "hide": 0,
        "includeAll": false,
        "label": null,
        "multi": false,
        "name": "podName",
        "options": [],
        "query": "label_values(jvm_memory_used_bytes{application =\"$application\", kubernetes_namespace =\"$namespace\"}, kubernetes_pod_name)",
        "refresh": 1,
        "regex": "",
        "skipUrlSync": false,
        "sort": 0,
